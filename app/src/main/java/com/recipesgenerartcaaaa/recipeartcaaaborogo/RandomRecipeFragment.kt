...
import com.recipesgenerartcaaaa.recipeartcaaaborogo.databinding.FragmentRandomRecipeBinding
...
class RandomRecipeFragment : Fragment() {
    ...
    private val sectors = arrayOf("Cabbage frie", "Creamy cabbage", "Hot and Sour Cabbage", "Boiled Cabbage", "Pak choi")
    private val sectorDegrees = arrayOf(1,1,1,1,1)
