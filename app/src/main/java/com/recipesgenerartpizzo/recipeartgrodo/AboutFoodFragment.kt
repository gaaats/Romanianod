...
import com.recipesgenerartpizzo.recipeartgrodo.databinding.FragmentAboutFoodBinding
...
class AboutFoodFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBenefits.setOnClickListener {
            findNavController().navigate(R.id.action_aboutFoodFragment_to_benefitsFragment)
        }
