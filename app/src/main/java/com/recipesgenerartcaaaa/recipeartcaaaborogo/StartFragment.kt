...
import com.recipesgenerartcaaaa.recipeartcaaaborogo.databinding.FragmentStartBinding
...
class StartFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            binding.btnGoToGameRandom.setOnClickListener {
                findNavController().navigate(R.id.action_startFragment_to_randomRecipeFragment)
            }
